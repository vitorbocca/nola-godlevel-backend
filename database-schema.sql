...
-- Create default brand (ID = 1) for the data generator
-- This ensures the brand exists before the data generator runs
INSERT INTO brands (id, name) VALUES (1, 'Challenge Brand');

-- Indexes for performance optimization
CREATE INDEX idx_sales_data_loja_canal_submarca 
ON sales (created_at DESC, store_id, channel_id, sub_brand_id);
